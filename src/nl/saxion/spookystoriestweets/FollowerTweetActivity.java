...
public class FollowerTweetActivity extends Activity implements Observer {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		currentUser = model.getFollowerList().get(intent.getIntExtra("position", 0));
		
		ivFollowerAvatar.setImageBitmap(FollowerAdapter.getImage(currentUser.getPictureURL()));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.follower_tweet, menu);
		return true;
	}
		...
		protected String doInBackground(Void... params) {
			...
			try {
				...
				HttpGet httpGet = new HttpGet(
							"https://api.twitter.com/1.1/statuses/user_timeline.json?user_id=" + currentUser.getUserId() + "&exclude_replies=t");
